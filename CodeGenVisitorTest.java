...
//		System.setOut(oldStream);
	...
	public void assng6Test0() throws Exception {
		...
		args[0] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image1.jpg");
		args[1] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image3.jpg");
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
	...
	public void assng6Test1() throws Exception {
		...
		args[0] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image2.jpg");
		args[1] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image3.jpg");
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
	...
	public void assng6Test4() throws Exception {
		...
		args[0] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image3.jpg");
		args[1] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image2.jpg");
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
	...
	public void assng6Test10() throws Exception {
		...
		args[0] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image2.jpg");
		args[1] = new String("/Users/sheikht/Documents/workspace/PLPHW4/src/images/image1.jpg");
		Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
		instance.run();
	}
    ...
    public void ivImage() throws Exception {
           ...
           // String[] args = new String[1]; //create command line argument array to initialize params, none in this case
            ...
            String[] args = new String[]{"https://s-media-cache-ak0.pinimg.com/736x/3c/90/c2/3c90c2c8621dd72a7dbedaec431e8be7.jpg", "/Users/sheikht/Documents/workspace/PLPHW4/src/images/image1.jpg"}; //create String[] array to initialize params
    	Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
            //Runnable instance = CodeGenUtils.getInstance(name, bytecode, args);
            instance.run();
    }
